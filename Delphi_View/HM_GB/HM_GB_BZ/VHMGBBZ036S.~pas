...
uses
  ...
  Dialogs, StdCtrls, TFlatEditUnit, TFlatComboBoxUnit, TFlatSpinEditUnit,
  TFlatButtonUnit, TFlatLabelUnit, ExtCtrls, TFlatPanelUnit, Grids,
  BaseGrid, AdvGrid, TFlatMemoUnit, TFlatCheckBoxUnit, TFlatGroupBoxUnit;
