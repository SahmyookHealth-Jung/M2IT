...
uses
  ...
  Dialogs, TFlatLabelUnit, StdCtrls, TFlatComboBoxUnit,
  TFlatRadioButtonUnit, TFlatCheckBoxUnit, TFlatGroupBoxUnit,
  TFlatButtonUnit, TFlatEditUnit, Grids, BaseGrid, AdvGrid, ExtCtrls,
  TFlatPanelUnit;
