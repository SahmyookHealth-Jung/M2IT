...
using static BaseCodeApp.BaseCode;
...
namespace BaseCodeApp
{
    public partial class BaseCode : Form
    {
        ...
        private void BaseCode_Load(object sender, EventArgs e)
        {
            ...
            pnlBig.BackColor = Color.FromArgb(215, 228, 242);
            pnlMedl.BackColor = Color.FromArgb(215, 228, 242);
            pnlSml.BackColor = Color.FromArgb(215, 228, 242);

            dgvBig.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(215, 228, 242);
        ...
        private void cboBizGubun_SelectedIndexChanged(object sender, EventArgs e)
        {
            LoadBigCode();
        }
